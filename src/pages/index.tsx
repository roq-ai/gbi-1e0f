  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to gbi - Revolutionizing Education Management. Empowering colleges and teachers to create, manage and track their own college systems, student attendance, and virtual classes."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1525921429624-479b6a26d84d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb2xsZWdlfGVufDB8fHx8MTY5NDAxODY0MHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@charlesdeloye?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Charles DeLoye`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to gbi - Revolutionizing Education Management. Empowering colleges and teachers to create, manage and track their own college systems, student attendance, and virtual classes.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="IT Support" type="it-support" abilities={appConfig.ownerAbilities} />
